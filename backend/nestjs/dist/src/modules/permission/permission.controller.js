...
const check_permissions_decorator_1 = require("../../core/decorators/check-permissions.decorator");
...
__decorate([
    (0, common_1.Post)(),
    (0, check_permissions_decorator_1.CheckPermissions)('create', 'permission'),
...
__decorate([
    (0, common_1.Get)(),
    (0, check_permissions_decorator_1.CheckPermissions)('read', 'permission'),
    __metadata("design:type", Function),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, check_permissions_decorator_1.CheckPermissions)('update', 'permission'),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
...
__decorate([
    ...
    (0, check_permissions_decorator_1.CheckPermissions)('delete', 'permission'),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", void 0)
